...
Partial Public Class DSNhanVien
    ...
    Partial Public Class NhanVienDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddNhanVienRow(ByVal maNV As String, ByVal tenNV As String, ByVal SDT As String, ByVal email As String, ByVal chucVu As String, ByVal luong As String) As NhanVienRow
        ...
        Private Sub InitClass()
            ...
            Me.columnluong = New Global.System.Data.DataColumn("luong", GetType(String), Nothing, Global.System.Data.MappingType.Element)
            ...
            Me.columnluong.ReadOnly = true
            Me.columnluong.MaxLength = 4000
        End Sub
    ...
    Partial Public Class NhanVienRow
        ...
        Public Property luong() As String
            Get
                Try 
                    Return CType(Me(Me.tableNhanVien.luongColumn),String)
                Catch e As Global.System.InvalidCastException
...
Namespace DSNhanVienTableAdapters
    ...
    Partial Public Class NhanVienTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [NhanVien] WHERE (([maNV] = ?) AND ((? = 1 AND [tenNV] IS NULL) OR (["& _ 
                "tenNV] = ?)) AND ((? = 1 AND [SDT] IS NULL) OR ([SDT] = ?)) AND ((? = 1 AND [ema"& _ 
                "il] IS NULL) OR ([email] = ?)) AND ((? = 1 AND [chucVu] IS NULL) OR ([chucVu] = "& _ 
                "?)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_maNV", Global.System.Data.OleDb.OleDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "maNV", Global.System.Data.DataRowVersion.Original, false, Nothing))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_tenNV", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "tenNV", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_tenNV", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "tenNV", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [NhanVien] ([maNV], [tenNV], [SDT], [email], [chucVu]) VALUES (?, ?, "& _ 
                "?, ?, ?)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("maNV", Global.System.Data.OleDb.OleDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "maNV", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("tenNV", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "tenNV", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [NhanVien] SET [maNV] = ?, [tenNV] = ?, [SDT] = ?, [email] = ?, [chucVu] ="& _ 
                " ? WHERE (([maNV] = ?) AND ((? = 1 AND [tenNV] IS NULL) OR ([tenNV] = ?)) AND (("& _ 
                "? = 1 AND [SDT] IS NULL) OR ([SDT] = ?)) AND ((? = 1 AND [email] IS NULL) OR ([e"& _ 
                "mail] = ?)) AND ((? = 1 AND [chucVu] IS NULL) OR ([chucVu] = ?)))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("maNV", Global.System.Data.OleDb.OleDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "maNV", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("tenNV", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "tenNV", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_maNV", Global.System.Data.OleDb.OleDbType.VarChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "maNV", Global.System.Data.DataRowVersion.Original, false, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_tenNV", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "tenNV", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_tenNV", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "tenNV", Global.System.Data.DataRowVersion.Original, false, Nothing))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "select maNV,tenNV,SDT,email,chucVu,format(luong,'##,#\ VNĐ','es-ES') as luong fro"& _ 
                "m NhanVien"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_maNV As String, ByVal Original_tenNV As String, ByVal Original_SDT As String, ByVal Original_email As String, ByVal Original_chucVu As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal maNV As String, ByVal tenNV As String, ByVal SDT As String, ByVal email As String, ByVal chucVu As String) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(4).Value = CType(chucVu,String)
            End If
        ...
        Public Overloads Overridable Function Update(ByVal maNV As String, ByVal tenNV As String, ByVal SDT As String, ByVal email As String, ByVal chucVu As String, ByVal Original_maNV As String, ByVal Original_tenNV As String, ByVal Original_SDT As String, ByVal Original_email As String, ByVal Original_chucVu As String) As Integer
            If (maNV Is Nothing) Then
                Throw New Global.System.ArgumentNullException("maNV")
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(chucVu,String)
            End If
            If (Original_maNV Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_maNV")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal tenNV As String, ByVal SDT As String, ByVal email As String, ByVal chucVu As String, ByVal Original_maNV As String, ByVal Original_tenNV As String, ByVal Original_SDT As String, ByVal Original_email As String, ByVal Original_chucVu As String) As Integer
            Return Me.Update(Original_maNV, tenNV, SDT, email, chucVu, Original_maNV, Original_tenNV, Original_SDT, Original_email, Original_chucVu)
        End Function
    End Class
